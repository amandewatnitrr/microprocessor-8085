LHLD 6501H ; Load the Multiplicand in HL Pair from the specified memory Address
XCHG ; exchange the content of HL Pair with DE
LDA 6503H ; Load the other number stored in 6503H location to the Accumulator
LXI H,0000H ; Set initial product in HL Pair to 00
...
SHLD 6504H ; Store result in 6504
HLT ; END
