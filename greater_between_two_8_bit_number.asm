MVI A,33H ; Transfer the First number to be compared to Accumulator               
MVI B,47H ; Transfer the second number to Register B
...
STA 0001;Now we will store the largest number in memory location 0000                                                 
HLT
